        ...
        <svg viewBox="0 0 220 340" role="presentation">
          ...
          <g className={styles.rocket}>
            ...
            <path
              ...
              d="M81 66c7-26 17-46 29-56 13 11 23 31 29 56-18-9-39-9-58 0Z"
            />
            <path
              className={styles.sideShade}
              d="M129 63c12 52 8 151-19 221 20-23 31-51 34-82 6-66 3-123-15-139Z"
            />
